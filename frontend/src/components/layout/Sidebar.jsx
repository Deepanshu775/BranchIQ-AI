...
import { LayoutGrid, Building2, Network as NetworkIcon, Map, Bot, Compass, BookOpen, Sparkles, UserCircle2 } from "lucide-react";
...
export default function Sidebar() {
  ...
  const closeOnMobile = () => { if (window.innerWidth < 1024) setNavOpen(false); };
  return (
    <aside
